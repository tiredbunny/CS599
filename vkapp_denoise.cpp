...
void VkApp::createDenoiseDescriptorSet()
{
    ...
    m_denoiseDesc.write(m_device, 2, m_rtNdCurrBuffer.Descriptor());  // The normal:depth buffer
    m_denoiseDesc.write(m_device, 3, m_rtKdCurrBuffer.Descriptor());  // The color buffer
...
void VkApp::createDenoiseCompPipeline()
{
    ...
    // @@ destroy m_denoisePipelineX, and m_denoisePipelineY, -> DONE
}
